      ...
      <div className="brand-container px-5 py-5 h-auto">
        <div className="bg-white shadow-xl">
          <div className="flex gap-4 py-3 justify-center items-center">
            <button
              className={`px-16 py-3 bg-secondary text-white font-medium rounded-sm ${
          ...
          <AnimatePresence initial={false} custom={isSignUp}>
            {isSignUp ? (
              <motion.div
                key="signup"
        ...
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <button className="w-full py-3 text-white rounded-xl bg-secondary">
                Sign In
              </button>
            </form>
          </div>
